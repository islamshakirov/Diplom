...
namespace ShakirovTranspComp
{
    ...
    public partial class cargo_trEntities : DbContext
    {
        ...
        public virtual DbSet<Arend> Arend { get; set; }
        ...
        public virtual DbSet<CarsKind> CarsKind { get; set; }
        public virtual DbSet<UsersOrders> UsersOrders { get; set; }
    
        public virtual int ResetAllCars()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ResetAllCars");
        }
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("TotalSum");
        }
    }
}
